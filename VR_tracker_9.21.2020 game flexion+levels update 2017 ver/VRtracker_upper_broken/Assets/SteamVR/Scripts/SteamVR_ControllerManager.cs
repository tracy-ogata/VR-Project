...
{
	public GameObject left, right, thigh;
   ...
   // uint thighIndex = OpenVR.k_unTrackedDeviceIndexOther;
    ...
    public void UpdateTargets()
	{
        ...
        objects[2] = thigh;
        indices[2] = OpenVR.k_unTrackedDeviceIndexOther;
	...
	static string[] labels = { "left", "right", "thigh" };
